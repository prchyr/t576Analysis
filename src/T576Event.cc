...
TGraph * T576Event::drawAvgHilbert(int major, int minor, int scopeOrSurf, int channel, int num, double align, double tLow, double tHigh, TString drawOption){
  int number=0;
  auto graphs=vector<TGraph*>();
  if(scopeOrSurf==0){
    for(int i=0;i<scopeNEvents;i++){
...
// TGraph * T576Event::avgGraph(int major, int minor, int scopeOrSurf, int channel, int num, double align, double tLow, double tHigh){
//   int number=0;
//   auto graphs=vector<TGraph*>();
//   if(scopeOrSurf==0){
//     for(int i=0;i<scopeNEvents;i++){
